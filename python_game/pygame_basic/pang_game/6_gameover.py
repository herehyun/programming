...
# 화면 타이틀 설정
pygame.display.set_caption("공 부시기") # 게임 이름
...
# 무기 만들기
weapon = pygame.image.load(os.path.join(image_path, "weapon.jpeg"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "bubble1.jpeg")),
    pygame.image.load(os.path.join(image_path, "bubble2.jpeg")),
    pygame.image.load(os.path.join(image_path, "bubble3.jpeg")),
    pygame.image.load(os.path.join(image_path, "bubble4.jpeg"))]
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            conitue # 안쪽 for 문 조건이 맞지 않으면 conitune. 바깥 for 문 계속 수행
